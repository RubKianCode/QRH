...
1. **Verify the CONDITION:** Ensure the symptoms match the document.
2. **Execute IMMEDIATE ACTIONS:** Do these *Memory Items* immediately to mitigate the issue (like pausing the booth or securing data) before doing deep diagnostics.
...
| :--- | :--- | :--- |
| **QrCode ไม่ขึ้น** | ลูกค้าสแกนไม่ได้ หรือ QR ไม่โชว์บนจอ | [01-QrCode-Error.md](./01-QrCode-Error.md) |
| **ปัญหารูปไม่ออก** | เครื่องพิมพ์ไม่ทำงาน กระดาษติด หมึกหมด | [02-Printer-Error.md](./02-Printer-Error.md) |
| **จ่ายเงินแต่ไม่ได้ถ่าย** | จ่ายผ่าน QR แล้วหลุด หน้าจอเด้งกลับ | [03-Payment-Error.md](./03-Payment-Error.md) |
| **โปรแกรมค้างหรือปิดเอง** | Software Crash, UI Freeze | [04-Software-Crash.md](./04-Software-Crash.md) |
